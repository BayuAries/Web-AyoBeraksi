...
<div class="card mx-auto shadow p-3 mb-5 bg-white rounded" style="width: 100%;">
    <div class="card-body">
        <h5 class="card-title border-bottom">Tabel Laporan Pengaduan</h5>
...
<script type="text/javascript">
    var showurl = '{{ route('laporan.pengaduan.show', '_rowid') }}';
    var editurl = '{{ route('laporan.pengaduan.edit', '_rowid') }}';
    $(document).ready(function() {
        // Databale for List
        var t = $('#datable').DataTable({
            ajax:{
                url: '{{ route('actions.pengaduan.list') }}',
                dataSrc: 'data'
            },
            columns: [
                {data: 'id',
