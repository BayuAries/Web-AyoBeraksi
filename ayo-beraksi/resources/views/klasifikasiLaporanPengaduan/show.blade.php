                        ...
                        <div class="col-md-12 col-sm">
                            ...
                            <div class="form-group" >
                                <label for="keterangan">Keterangan Hasil Penyelesaian Laporan</label>
                                    <textarea class="form-control" id="keterangan" name="keterangan" placeholder="Keterangan Hasil Penyelesaian Laporan" value="{{ isset($detailKlasifikasi) ? $detailKlasifikasi->keterangan : 'Belum ada' }}" readonly>{{ isset($detailKlasifikasi) ? $detailKlasifikasi->keterangan: 'Belum ada' }}</textarea>
                                    <div class="invalid-feedback" id="invalid-keterangan"></div>
                            </div>
                            <div class="form-group">
                            <a href="{{ route('klasifikasi.pengaduan.index') }}" class="btn btn-primary float-right">Kembali</a>
                            </div>
